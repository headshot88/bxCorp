	...
	var BurnDownChart = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(BurnDownChart, [{
	    ...
	    value: function onSidePanelLoad() {
	      ...
	      setTimeout(function () {
	        _this2.createChart(_this2.node, _this2.chartData);

	        main_core.Dom.insertBefore(_this2.renderInfo(_this2.sprintData), _this2.node);
	      }, 300);
	    }
	  }, {
	    ...
	    value: function createContent() {
	      ...
	      return new Promise(function (resolve, reject) {
	        main_core.ajax.runAction('bitrix:tasks.scrum.sprint.getBurnDownChartData', {
	          ...
	          _this3.sprintData = response.data.sprint;
	          _this3.chartData = response.data.chart;
	          resolve(_this3.renderChart());
	        });
	      });
	    }
	  }, {
	    ...
	    value: function renderChart() {
	      this.node = main_core.Tag.render(_templateObject || (_templateObject = babelHelpers.taggedTemplateLiteral(["<div class=\"tasks-scrum-sprint-burn-down-chart\"></div>"])));
	      return this.node;
	    }
	  }, {
	    key: "renderInfo",
	    value: function renderInfo(sprint) {
	      return main_core.Tag.render(_templateObject2 || (_templateObject2 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t<div class=\"tasks-scrum-sprint-burn-down-info\">\n\t\t\t\t<div class=\"tasks-scrum-sprint-burn-down-info-name\">\n\t\t\t\t\t", "\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t"])), main_core.Text.encode(sprint.name));
	    }
	  }, {
	    key: "createChart",
